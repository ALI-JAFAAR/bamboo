		...
		<div class="container pl-20">
			...
			<div class="counter-counter grid-4">
				...
				<div class="fun-fact">
					...
					<div class="fun-desc">
						<p class="timer" data-to="{{ __('theme::about.workinghour') }}" data-speed="3000">{{ __('theme::about.workinghour') }}</p>
				...
				<div class="fun-fact fun-active">
					...
					<div class="fun-desc">
						<p class="timer" data-to="{{ __('theme::about.totalproject') }}" data-speed="3000">{{ __('theme::about.totalproject') }}</p>
				...
				<div class="fun-fact">
					...
					<div class="fun-desc">
						<p class="timer" data-to="{{ __('theme::about.journey-year') }}" data-speed="3000">{{ __('theme::about.journey-year') }}</p>
				...
				<div class="fun-fact">
					...
					<div class="fun-desc">
						<p class="timer" data-to="{{ __('theme::about.toatalclient') }}" data-speed="3000">{{ __('theme::about.toatalclient') }}</p>
